...
#ifndef FLATBUFFERS_GENERATED_SCHEMAV3A_TFLITE_H_
#define FLATBUFFERS_GENERATED_SCHEMAV3A_TFLITE_H_
...
inline const char *EnumNameTensorType(TensorType e) {
  if (e < TensorType_FLOAT32 || e > TensorType_COMPLEX128) return "";
...
inline const char *EnumNameBuiltinOperator(BuiltinOperator e) {
  if (e < BuiltinOperator_ADD || e > BuiltinOperator_PLACEHOLDER_FOR_GREATER_OP_CODES) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameBuiltinOptions(BuiltinOptions e) {
  if (e < BuiltinOptions_NONE || e > BuiltinOptions_BatchMatMulOptions) return "";
  const size_t index = static_cast<size_t>(e);
...
#endif  // FLATBUFFERS_GENERATED_SCHEMAV3A_TFLITE_H_
